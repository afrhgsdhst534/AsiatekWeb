...
import { Route, Redirect, Link, useLocation, useRoute, Router, Switch } from "wouter";
...
import { pgTable, timestamp, text, serial, json, integer, boolean } from "drizzle-orm/pg-core";
  ...
  if (!res.ok) {
    try {
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        throw new Error(`${res.status}: ${text2 || res.statusText}`);
      }
    } catch (e) {
...
function ProtectedComponent({
  ...
  return /* @__PURE__ */ jsx(Component2, { ...params });
}
function cn(...inputs) {
...
const firstTickerLogos = [
  ...
  {
    id: "logo-9",
    image: "/assets/logos/volkswagen.png",
    alt: "volkswagen"
  }
];
const secondTickerLogos = [
  {
    id: "row2-logo-1",
    image: "/assets/logos/row2/jac.png",
    alt: "jac logo"
  },
  {
    id: "row2-logo-2",
    image: "/assets/logos/row2/sitrak.png",
    alt: "sitrak logo"
  },
  {
    id: "row2-logo-3",
    image: "/assets/logos/row2/faw.png",
    alt: "faw logo"
  },
  {
    id: "row2-logo-4",
    image: "/assets/logos/row2/howo.png",
    alt: "howo logo"
  },
  {
    id: "row2-logo-5",
    image: "/assets/logos/row2/shacman.png",
    alt: "shacman logo"
  },
  {
    id: "row2-logo-6",
    image: "/assets/logos/row2/sinotruk.png",
    alt: "sinotruk logo"
  },
  {
    id: "row2-logo-7",
...
const thirdTickerLogos = [
  {
    id: "row3-logo-1",
    image: "/assets/logos/row3/brilliance.png",
    alt: "brilliance logo"
  },
  {
    id: "row3-logo-2",
    image: "/assets/logos/row3/changan.png",
    alt: "changan logo"
  },
  {
    id: "row3-logo-3",
    image: "/assets/logos/row3/chery.png",
    alt: "chery logo"
  },
  {
    id: "row3-logo-4",
    image: "/assets/logos/row3/dfm.png",
    alt: "dfm logo"
  },
  {
    id: "row3-logo-5",
    image: "/assets/logos/row3/exeed.png",
    alt: "exeed logo"
  },
  {
    id: "row3-logo-6",
    image: "/assets/logos/row3/faw.png",
    alt: "faw logo"
  },
  {
    id: "row3-logo-7",
    image: "/assets/logos/row3/gac.png",
    alt: "gac logo"
  },
  {
    id: "row3-logo-8",
    image: "/assets/logos/row3/geely.png",
    alt: "geely logo"
  },
  {
    id: "row3-logo-9",
    image: "/assets/logos/row3/haval.png",
    alt: "haval logo"
  },
  {
    id: "row3-logo-10",
    image: "/assets/logos/row3/lifan.png",
    alt: "lifan logo"
  }
];
const Seo = ({
  ...
  image = "/assets/social-preview-banner.png",
  // <-- Use the new banner path
  // --- END UPDATE ---
  type = "website",
  brand,
  noindex = false,
...
const FAQ = ({ items }) => {
  ...
  return /* @__PURE__ */ jsx(Helmet, { children: /* @__PURE__ */ jsx("script", { type: "application/ld+json", children: JSON.stringify(structuredData) }) });
};
const HomePage = () => {
  const isMobile = useIsMobile();
  const faqItems = [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative z-10 flex items-center justify-center h-full px-4", children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "font-['Inter'] font-medium text-sm sm:text-base leading-relaxed tracking-[-0.03em] text-gray-700/90", children: "Доставим запчасти из США, Китая и Кореи в кратчайшие сроки. Для этого оставьте короткую заявку , которая займет пару минут. Просто укажите данные автомобиля, нужные запчасти и ваши контакты." }),
...
const manualSchema = z.object({
  ...
  // VIN is optional when using manual
  make: z.string().min(1, "Марка обязательна"),
  model: z.string().min(1, "Модель обязательна"),
  year: z.string().min(4, "Год обязателен (ГГГГ)").max(4, "Год обязателен (ГГГГ)").regex(/^\d{4}$/, "Год должен быть в формате ГГГГ").refine(
    (val) => parseInt(val) >= 1900 && parseInt(val) <= (/* @__PURE__ */ new Date()).getFullYear() + 1,
    {
...
const StepTwo = ({ vehicle, onBack, onNext }) => {
  const [inputMethod, setInputMethod] = useState("vin");
  ...
  const onSubmit = (values) => {
    ...
    if (inputMethod === "vin") {
      ...
      vehicleDetails = {
        ...
        make: values.make,
        model: values.model,
        year: values.year && /^\d{4}$/.test(values.year) ? parseInt(values.year) : void 0,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "step-container", children: [
    /* @__PURE__ */ jsxs("h2", { className: "text-xl font-medium text-foreground mb-6", children: [
      "Информация о транспортном средстве (",
      vehicle.type === "passenger" ? "Легковой" : vehicle.type === "commercial" ? "Коммерческий" : vehicle.type === "chinese" ? "Китайский" : "",
      ")"
    ] }),
      ...
      "form",
      {
        ...
        children: [
          inputMethod === "vin" && /* @__PURE__ */ jsx(
            FormField,
            {
              ...
              render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: "17 символов, указан в СТС/ПТС." }),
                /* @__PURE__ */ jsx(FormMessage, {})
              ] })
            }
          ),
          inputMethod === "manual" && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx(
                FormField,
                {
                  ...
                  render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    ...
                    /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(Input, { placeholder: "Toyota, BMW, Chery...", ...field }) }),
                    /* @__PURE__ */ jsx(FormMessage, {})
                  ] })
                }
              ),
              /* @__PURE__ */ jsx(
                FormField,
                {
                  ...
                  render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    ...
                    /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(Input, { placeholder: "Camry, X5, Tiggo...", ...field }) }),
                    /* @__PURE__ */ jsx(FormMessage, {})
                  ] })
                }
              )
              ...
              /* @__PURE__ */ jsx(
                FormField,
                {
                  ...
                  render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    ...
                    /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(Input, { placeholder: "ГГГГ (напр. 2022)", type: "number", ...field }) }),
                    /* @__PURE__ */ jsx(FormMessage, {})
                  ] })
                }
              ),
              /* @__PURE__ */ jsx(
                FormField,
                {
                  ...
                  render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    ...
                    /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(Input, { placeholder: "Напр. 2.0, 3.5", ...field }) }),
                    /* @__PURE__ */ jsx(FormMessage, {})
                  ] })
                }
              ),
                ...
                FormField,
                {
                  ...
                  render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    ...
                    /* @__PURE__ */ jsxs(Select, { onValueChange: field.onChange, defaultValue: field.value, children: [
                      /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Выберите тип" }) }) }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex justify-between", children: [
            /* @__PURE__ */ jsx(Button, { type: "button", variant: "outline", onClick: onBack, children: "Назад" }),
            /* @__PURE__ */ jsx(Button, { type: "submit", children: "Продолжить" })
          ] })
        ]
      }
    ) })
...
createInsertSchema(users).pick({
  ...
  // Optional here, required by contactInfo
  countryCode: z.string().min(1, "Код страны обязатеlen").optional(),
  // Optional here, required by contactInfo
...
const vehicleSchema = z.object({
  ...
  make: z.string().optional(),
  model: z.string().optional(),
  year: z.number().int().min(1900).max((/* @__PURE__ */ new Date()).getFullYear() + 1).optional().nullable(),
...
createInsertSchema(orders).pick({
  userId: true,
  // Keep it picked
  vehicle: true,
  parts: true,
...
createInsertSchema(contactMessages).pick({
  name: true,
  email: true,
  phone: true,
  countryCode: true,
...
const StepThree = ({ parts, onBack, onNext }) => {
  const form = useForm({
    ...
    defaultValues: {
      ...
      parts: parts.length > 0 ? parts : [{ name: "", quantity: 1 }]
  ...
  return /* @__PURE__ */ jsxs("div", { className: "step-container", children: [
    /* @__PURE__ */ jsx("h2", { className: "text-xl font-medium text-foreground mb-6", children: "Список запчастей" }),
    /* @__PURE__ */ jsx(Form, { ...form, children: /* @__PURE__ */ jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "space-y-4", children: fields.map((field, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "border border-border rounded-md p-4 md:p-6 space-y-4 relative",
          children: [
            fields.length > 1 && /* @__PURE__ */ jsxs(
              Button,
              {
                type: "button",
                variant: "ghost",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Удалить" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
              ...
              /* @__PURE__ */ jsx(
                FormField,
                {
                  ...
                  render: ({ field: field2 }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    /* @__PURE__ */ jsx(FormLabel, { children: "Артикул" }),
                    /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(Input, { placeholder: "Ориг. номер / SKU", ...field2 }) }),
                    /* @__PURE__ */ jsx(FormMessage, {})
                  ] })
                }
              ),
              /* @__PURE__ */ jsx(
                FormField,
                {
                  ...
                  render: ({ field: controllerField }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                    /* @__PURE__ */ jsx(FormLabel, { children: "Кол-во *" }),
                    /* @__PURE__ */ jsx(
                      Controller,
                      {
                        control: form.control,
                        name: `parts.${index}.quantity`,
                        render: ({ field: field2 }) => /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
                          /* @__PURE__ */ jsx(
                            Button,
                            {
                              type: "button",
                              ...
                              onClick: () => field2.onChange(
                                Math.max(1, (field2.value || 1) - 1)
                              ),
                              disabled: field2.value <= 1,
                              children: "-"
                            }
                          ),
                          /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                          ...
                          /* @__PURE__ */ jsx(
                            Button,
                            {
                              ...
                              onClick: () => field2.onChange((field2.value || 0) + 1),
                              children: "+"
                            }
                          )
                        ] })
            ...
            /* @__PURE__ */ jsx(
              FormField,
              {
                ...
                render: ({ field: field2 }) => /* @__PURE__ */ jsxs(FormItem, { children: [
                  /* @__PURE__ */ jsx(FormLabel, { children: "Бренд" }),
                  /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                    Input,
                    {
...
const PhoneInput = ({
  ...
  const formatPhoneNumber = (input, country) => {
    ...
    let patternIndex = 0;
    let digitIndex = 0;
    while (patternIndex < country.format.length && digitIndex < limitedDigits.length) {
      ...
      if (patternChar === "X") {
        ...
        patternIndex++;
        if (patternIndex === country.format.length && digitIndex < limitedDigits.length) ;
      }
    }
    return formatted;
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    !suppressChrome && label && /* @__PURE__ */ jsxs(
      Label,
      {
        htmlFor: "phone",
    ...
    !suppressChrome && (error ? /* @__PURE__ */ jsx("p", { className: "text-destructive text-sm mt-1", children: error }) : /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground text-sm mt-1", children: [
      "Формат: ",
...
const StepFour = ({ onBack, onSubmit, isLoading }) => {
  var _a2;
  const { user } = useAuth();
  ...
  const handleStepFourButtonClick = () => {
    ...
    const dataToSubmit = isLoggedIn ? { ...stepData, createAccount: false, password: "", passwordConfirm: "" } : stepData;
    console.log(
  ...
  return /* @__PURE__ */ jsxs("div", { className: "step-container", children: [
    /* @__PURE__ */ jsxs("h2", { className: "mb-6 text-xl font-medium text-foreground", children: [
      "Контактная информация",
      " ",
      isLoggedIn && /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "(используются данные профиля)" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx(
          FormField,
          {
            ...
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { children: [
              ...
              /* @__PURE__ */ jsx(FormDescription, { className: isLoggedIn ? "hidden" : "", children: !watchCreateAccount ? "Укажите, если хотите получать уведомления о заказе." : "Необходим для создания аккаунта." }),
              /* @__PURE__ */ jsx(FormMessage, {})
            ] })
          }
        )
              ...
              return /* @__PURE__ */ jsxs(FormItem, { children: [
                ...
                /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                  PhoneInput,
                  {
                    ...
                    onCountryCodeChange: (cc) => form.setValue("countryCode", cc, { shouldValidate: true }),
                    disabled: isLoggedIn,
                    suppressChrome: true,
                    error: ((_a3 = form.formState.errors.phone) == null ? void 0 : _a3.message) || ((_b2 = form.formState.errors.countryCode) == null ? void 0 : _b2.message)
                  }
                ) }),
                /* @__PURE__ */ jsx(FormDescription, { children: "Формат: XXX XXX XX XX" }),
                /* @__PURE__ */ jsx(FormMessage, {})
              ] });
            }
          }
      ...
      !isLoggedIn && /* @__PURE__ */ jsxs("div", { className: "pt-4 space-y-4", children: [
        /* @__PURE__ */ jsx(
          FormField,
          {
            control: form.control,
            name: "createAccount",
            render: ({ field }) => /* @__PURE__ */ jsxs(FormItem, { className: "flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow-sm bg-muted/30", children: [
              /* @__PURE__ */ jsx(FormControl, { children: /* @__PURE__ */ jsx(
                Checkbox,
                {
                  checked: field.value,
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1 leading-none", children: [
                /* @__PURE__ */ jsx(
                  Label,
                  {
                    ...
                    children: "Создать аккаунт (не обязательно)"
                  }
                ),
                /* @__PURE__ */ jsx(FormDescription, { children: "Позволит отслеживать заказы и сохранит ваши данные." })
              ] })
            ] })
          }
        ),
        watchCreateAccount && /* @__PURE__ */ jsxs("div", { className: "space-y-6 p-4 border rounded-md shadow-inner mt-4 bg-muted/20", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-base font-medium text-foreground", children: "Установите пароль для нового аккаунта" }),
          /* @__PURE__ */ jsx(
            FormField,
            {
              control: form.control,
      ...
      ((_a2 = form.formState.errors.root) == null ? void 0 : _a2.message) && /* @__PURE__ */ jsxs(Alert, { variant: "destructive", className: "mt-4", children: [
...
const OrderForm = () => {
  ...
  const submitOrderMutation = useMutation({
    mutationFn: async (payload) => {
      ...
      if (!res.ok) {
        const errorData = await res.json().catch(() => ({ message: `Ошибка сервера (${res.status})` }));
    ...
    onSuccess: async (data) => {
      ...
      try {
        ...
        if ((data == null ? void 0 : data.user) && !isLoggedIn && ((_a2 = data == null ? void 0 : data.message) == null ? void 0 : _a2.toLowerCase().includes("created"))) {
          ...
          await queryClient2.invalidateQueries({ queryKey: ["/api/user"] });
          console.log(
        ...
        await queryClient2.invalidateQueries({ queryKey: ["/api/orders"] });
        ...
        toast2({
          ...
          description: error instanceof Error ? error.message : "Произошла внутренняя ошибка.",
          variant: "destructive"
        });
      }
    },
    onError: (error) => {
      ...
      toast2({
        ...
        // Display the actual error message caught
        variant: "destructive"
      });
    }
  });
  const goBack = () => currentStep > 1 && setCurrentStep((s) => s - 1);
  const handleStepOneSubmit = (vehicleType) => {
  ...
  const handleStepTwoSubmit = (stepTwoData) => {
    ...
    formMethods.setValue("vehicle", { ...currentVehicle, ...stepTwoData });
    console.log(
  ...
  const handleStepThreeSubmit = (stepThreeData) => {
    formMethods.setValue("parts", stepThreeData.parts);
    console.log(
  ...
  const handleStepFourSubmit = (stepFourData) => {
    ...
    formMethods.handleSubmit(
      ...
      (errors) => {
        ...
        else if (errors.parts && (Array.isArray(errors.parts) ? errors.parts.length > 0 : errors.parts.message))
          errorMsg = "Проверьте данные о запчастях (Шаг 3).";
        else if (errors.name || errors.email || errors.phone || errors.countryCode || errors.password || errors.passwordConfirm)
  ...
  const renderCurrentStep = () => {
    ...
    switch (currentStep) {
      case 1:
        return /* @__PURE__ */ jsx(StepOne, { onNext: handleStepOneSubmit });
      case 2:
        return /* @__PURE__ */ jsx(
          StepTwo,
          {
  ...
  return /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl", children: [
    /* @__PURE__ */ jsx("div", { className: "mb-2 flex items-center justify-between", children: /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold text-foreground", children: "Оформление заказа" }) }),
    /* @__PURE__ */ jsx(ProgressBar, { currentStep, totalSteps: 4 }),
    /* @__PURE__ */ jsx(FormProvider, { ...formMethods, children: /* @__PURE__ */ jsx("div", { className: "mt-8", children: renderCurrentStep() }) }),
    /* @__PURE__ */ jsx(
      SuccessModal,
      {
        ...
        onClose: () => {
          ...
          setCurrentStep(1);
          navigate(
            isLoggedIn || ((_a2 = submitOrderMutation.data) == null ? void 0 : _a2.user) ? "/dashboard" : "/"
          );
        }
      }
    )
                      ...
                      render: ({ field: countryField }) => {
                        ...
                        return /* @__PURE__ */ jsx(
                          PhoneInput,
                          {
                            ...
                            error: (_a2 = form.formState.errors.phone) == null ? void 0 : _a2.message
                          }
                        );
                      }
                    }
                          ...
                          render: ({ field: countryField }) => {
                            ...
                            return /* @__PURE__ */ jsx(
                              PhoneInput,
                              {
                                ...
                                countryCode: countryField.value,
                                onCountryCodeChange: countryField.onChange,
                                error: (_a2 = registerForm.formState.errors.phone) == null ? void 0 : _a2.message
                              }
                            );
                          }
                        }
...
function DashboardPage() {
  ...
  const { data: orders2, isLoading } = useQuery({
    queryKey: ["/api/orders"],
    enabled: !!user
  });
      ...
      Tabs,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("section", { className: "mt-4 rounded-xl border bg-white p-5 md:p-6 shadow-sm", children: [
            /* @__PURE__ */ jsx(TabsContent, { value: "orders", forceMount: true, hidden: tab !== "orders", children: /* @__PURE__ */ jsx(Orders, { orders: orders2, isLoading }) }),
            /* @__PURE__ */ jsx(
              TabsContent,
              {
                value: "profile",
...
function Orders({
  ...
  if (!(orders2 == null ? void 0 : orders2.length))
    return /* @__PURE__ */ jsx(
      Empty,
      {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-5", children: orders2.map((o) => {
      const v = o.vehicle || {};
      const parts = o.parts || [];
...
function ProductLD(p) {
  ...
  return /* @__PURE__ */ jsx(Helmet, { children: /* @__PURE__ */ jsx("script", { type: "application/ld+json", children: JSON.stringify(ld) }) });
}
...
function CatalogPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold mb-4", children: "Каталог товаров" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6", children: filteredProducts.length === 0 ? /* @__PURE__ */ jsx("p", { children: "Нет товаров" }) : filteredProducts.map((product) => /* @__PURE__ */ jsxs("div", { className: "border rounded-xl p-4 shadow-sm bg-white", children: [
      /* @__PURE__ */ jsx("img", { src: product.image, alt: product.name, className: "w-full h-40 object-cover rounded" }),
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold mt-2", children: product.name }),
      /* @__PURE__ */ jsxs("p", { className: "text-gray-700 mt-1", children: [
        product.price,
        " ₽"
      ] })
    ] }, product.id)) })
...
const logoPath$1 = "/assets/logos/asiatek-logo-full.png";
const Header = () => {
...
const logoPath = "/assets/logos/asiatek-logo-full.png";
const Footer = () => {
...
function AppRouter() {
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen flex-col", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-grow", children: /* @__PURE__ */ jsxs(Switch, { children: [
      ...
      /* @__PURE__ */ jsx(Route, { path: "/catalog", component: CatalogPage }),
...
function App() {
  ...
  const defaultDescription = "Asiatek - Надежный поставщик автозапчастей для китайских, корейских, японских и европейских автомобилей. Запчасти оптом и в розницу с доставкой по России.";
  const defaultImageUrl = "https://asiatek.pro/assets/asiatek-preview.png";
  const siteUrl = "https://asiatek.pro";
  return (
    // HelmetProvider should wrap everything that might use Helmet
    /* @__PURE__ */ jsx(HelmetProvider, { children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxs(AuthProvider, { children: [
      /* @__PURE__ */ jsxs(Helmet, { children: [
        /* @__PURE__ */ jsx("html", { lang: "ru" }),
        /* @__PURE__ */ jsx("title", { children: defaultTitle }),
        " ",
        /* @__PURE__ */ jsx("meta", { name: "description", content: defaultDescription }),
        " ",
        /* @__PURE__ */ jsx("meta", { property: "og:type", content: "website" }),
        /* @__PURE__ */ jsx("meta", { property: "og:url", content: siteUrl }),
        /* @__PURE__ */ jsx("meta", { property: "og:title", content: defaultTitle }),
        /* @__PURE__ */ jsx("meta", { property: "og:description", content: defaultDescription }),
        /* @__PURE__ */ jsx("meta", { property: "og:image", content: defaultImageUrl }),
        ...
        /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: defaultTitle }),
        /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: defaultDescription }),
        /* @__PURE__ */ jsx("meta", { name: "twitter:image", content: defaultImageUrl })
      ] }),
      /* @__PURE__ */ jsxs(Router, { children: [
        /* @__PURE__ */ jsx(AppRouter, {}),
        " "
      ] }),
...
async function renderPage(url) {
  ...
  try {
    appHtml = renderToString(
      /* @__PURE__ */ jsx(HelmetProvider, { context: helmetContext, children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient2, children: /* @__PURE__ */ jsx(Router, { ssrPath: url, ssrContext, children: /* @__PURE__ */ jsx(App, {}) }) }) })
    );
  } catch (renderError) {
  ...
  return {
    ...
    // If a <Redirect> was rendered, it populates this
  };
}
export {
  renderPage
